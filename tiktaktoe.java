...
public class tiktaktoe{
    public static String askForInput(Scanner scanner, String[][] board, int player) {
        boolean bool = true;
    ...
    public static void main(String args[]) {
        ...
        int turns = 0;
        while(true) {
            Scanner input1 = new Scanner(askForInput(scanner, board, 1));
            ...
            Scanner input2 = new Scanner(askForInput(scanner, board, 2));
